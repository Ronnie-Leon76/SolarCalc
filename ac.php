...
?>
<?php echo page_header('SOLARCALC | AC Borehole Pumps'); ?>
				...
				<div class="sidebar-sticky">
					<form class="sizing sizing-form">
						...
						<div class="form-group row first-child first-child-row">
							...
							<div class="col-md-12" data-toggle="tooltip" title="To be more precise, pick the location from Google Maps or set the GPS coordinates" data-placement="left">
								<a href="#" class="btn btn-outline-dark get-gps btn-block" data-toggle="modal" data-target=".googlemaps-modal">
									<i class="fas fa-map-marker-alt"></i> Select / Search Location
								</a>
							</div>
						...
						<div class="form-group row">
							<label class="col-md-8 required">Cable Length (m)</label>
							<div class="col-md-4">
						...
						<div class="form-group row d-none">
							<label class="col-md-8 required">Static Head (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="pipe_head" required="required">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-8 required">Elevation (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="elevation" required="required">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-8 required">Pumping Water Level Depth</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="water_level" required="required">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-md-8 required">Borehole Depth (m)</label>
							<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-8 required">Exp. Output (m<sup>3</sup>/<span class="output-option-text">day</span>)<span class="expected-daily-output"></span></label>
							<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-8">Sizing for <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="This will allow you to size the Pumping system based on the highest or lowest output. See the Irradiation tab to check this"></i></label>
							<div class="col-md-4">
						...
						<div class="form-group row last-row">
							<label class="col-md-8 custom-module" for="custom-factor">Set Module Oversizing Factor <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="Please note that the default minimum module oversizing factor is set at <?php echo MIN_PANEL_UPLIFT ?> and maximum of <?php echo MAX_PANEL_UPLIFT ?>"></i></label>
							<div class="col-md-4">
						...
						<button class="btn btn-dark btn-lg calculate-sizing">Start / Calculate <i class="fas fa-arrow-right"></i></button>
					</form>
				</div>
			</nav>
					...
					<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
						<div class="col results-image">
							...
							<svg viewBox="0 0 100 100">
								...
								<line x1="98%" y1="3.2%" x2="112" y2="3.2%" class="pipe-length-line" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />
								<line x1="111.7" y1="3.2%" x2="111.7" class="pipe-length-line" y2="6%" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />
