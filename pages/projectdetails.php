				...
				<table class="table table-sm">
					<tbody>
						...
						<tr>
							...
							<td style="width: 15%" class="total-dynamic-details">TDH <?php echo $project->project_details->tdh; ?>, Static <?php echo $project->project_details->sizing['pipe_head']; ?>m</td>
						</tr>
					</tbody>
				</table>
				<?php if(isset($project->project_details->sizing['add_site_borehole_conditions']) && $project->project_details->sizing['add_site_borehole_conditions'] == 'on'){ ?>
				<table class="table table-sm">
					<tbody>
						<tr>
							<td colspan="10">
						...
						<tr>
							...
							<td style="width: 10%"><?php echo $sizing['minimum_borehole_diameter']; ?></td>
							<td style="width: 15%">Static Water Level (m):</td>
							<td style="width: 10%"><?php echo $sizing['static_water_level']; ?></td>
							<td style="width: 15%">Borehole Tested Yield (m):</td>
							<td style="width: 10%"><?php echo $sizing['borehole_tested_yield']; ?></td>
							<td style="width: 15%">Pump Inlet Depth (m):</td>
							<td style="width: 10%"><?php echo $sizing['pump_inlet_depth']; ?></td>
						</tr>
						<tr>
							<td style="width: 15%">Main Aquifer (m):</td>
							<td style="width: 10%"><?php echo $sizing['main_aquifer']; ?></td>
							<td style="width: 15%">Distance to Solar Array (m):</td>
							<td style="width: 10%"><?php echo $sizing['distance_to_solar_array']; ?></td>
							<td style="width: 15%">Distance to Delivery Point (m):</td>
							<td style="width: 35%" colspan="3"><?php echo $sizing['distance_to_delivery_point']; ?></td>
						</tr>
					</tbody>
				</table>
			<?php } ?>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col footer-buttons">
				...
				<?php } else { ?>
				<button class="btn btn-primary print-ac-pdf float-right" data-project="<?php echo $get->project_id; ?>">Print Project <i class="far fa-save"></i></button>
				<?php } ?>
			</div>
		</div>
	</div>
