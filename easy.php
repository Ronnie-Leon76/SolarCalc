...
?>
<?php echo page_header('SOLARCALC | Easy Borehole Pump Sizing'); ?>
		...
		<div class="row">
				...
				<div class="sidebar-sticky">
					<form class="sizing sizing-form">
						...
						<div class="form-group row d-none">
							<label class="col-md-8">Cable Length (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="cable_length">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-6">Diameter - Ø Section (mm<sup>2</sup>)</label>
							<div class="col-md-6">
								<input type="number" class="form-control" name="diameter">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-6 required">Head (m) <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="The height from the Pumping Water Level to the Delivery Point "></i></label>
							<div class="col-md-6">
								<input type="number" class="form-control" name="pipe_head" required="required">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-8">Elevation (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="elevation">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-8">Pumping Water Level Depth</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="water_level">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-8">Pipe Length (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="pipe_length">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-8">Pipe Inner Diameter Ø - Inch</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="inner_diameter">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-8">Borehole Depth (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="borehole_depth">
							</div>
						</div>
						<div class="form-group row d-none">
							<label class="col-md-8">Pipe Material</label>
							<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-6 required">Output (m<sup>3</sup>/<span class="output-option-text">day</span>)<span class="expected-daily-output"></span></label>
							<div class="col-md-6">
						...
						<div class="form-group row last-row">
							<label class="col-md-6 custom-module" for="custom-module">Include iDayliff option <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="Add iDayliff remote monitoring option into the report"></i></label>
							<div class="col-md-6">
								<input type="hidden" name="idayliff">
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input" id="custom-idayliff" name="idayliff" checked="checked">
									<label class="custom-control-label" for="custom-idayliff"></label>
								</div>
							</div>
						</div>
						<div class="form-group row last-row d-none">
							<label class="col-md-8 custom-module" for="custom-site">Add Site & Borehole Conditions</label>
							<div class="col-md-4">
								<input type="checkbox" name="add_site_borehole_conditions" class="check-input" id="custom-site">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Minimum Borehole Diameter (inch)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="minimum_borehole_diameter">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Static Water Level (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="static_water_level">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Borehole Tested Yield (m<sup>3</sup>/hr)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="borehole_tested_yield">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Pump Inlet Depth (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="pump_inlet_depth">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Main Aquifer</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="main_aquifer">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Distance to Solar Array (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="distance_to_solar_array">
							</div>
						</div>
						<div class="form-group row borehole-conditions d-none">
							<label class="col-md-8">Distance to delivery point (m)</label>
							<div class="col-md-4">
								<input type="number" class="form-control" name="distance_to_delivery_point">
							</div>
						</div>
						<input type="hidden" name="average_output" readonly="readonly">
						<button class="btn btn-dark btn-lg calculate-sizing-simple">Start / Calculate <i class="fas fa-arrow-right"></i></button>
					</form>
				</div>
			</nav>
			<div class="col-md-9 col-lg-9 result-area">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="one" aria-selected="true">Schema - AC Pump</a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link d-nonez" id="six-tab" data-toggle="tab" href="#six" role="tab" aria-controls="six" aria-selected="false">Report</a>
					</li>
				</ul>
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
						<div class="col results-image">
							<img src="img/Pump-Placement-Schema.png" class="img-fluid schema-pump" usemap="#results-diagram">
							<svg viewBox="0 0 100 100">
								<line x1="50%" y1="45.8%" x2="50%" y2="80.5%" class="pipe-length-line" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />
								<line x1="50%" y1="46.1%" x2="98.3" y2="46.1%" class="pipe-length-line" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />
								<line x1="98" y1="2.9%" x2="98" y2="45.8%" class="pipe-length-line" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />
								<line x1="98%" y1="3.2%" x2="115" y2="3.2%" class="pipe-length-line" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />
								<line x1="114.7" y1="3.2%" x2="114.7" class="pipe-length-line" y2="6%" style="stroke:rgb(100, 100, 100); stroke-width:0.7" />

								<!-- Static Head Line -->
								<polygon points="52,3 51,5 53,5" class="system-head-polygon" style="fill: black" />
								<polygon points="51,64 52,66 53,64" class="system-head-polygon" style="fill: black" />
								<line x1="52" y1="3.8%" x2="52" y2="65.8%" class="system-head-line" style="stroke:rgb(0, 0, 0); stroke-width:0.2" />

								<!-- Elevation Line -->
								<line x1="73" y1="3.8%" x2="73" y2="46.8%" class="elevation-height-line" style="stroke:rgb(0, 0, 0); stroke-width:0.2" />
								<polygon points="72,47 73,49 74,47" class="elevation-height-polygon" style="fill: black" />
								<polygon points="73,3 72,5 74,5" class="elevation-height-polygon" style="fill: black" />

								<!-- Pumping Water Level -->
								<line x1="73" y1="51%" x2="73" y2="64%" class="water-level-line" style="stroke:rgb(255, 255, 255); stroke-width:0.2" />
								<polygon points="72,51 73,49 74,51" class="water-level-polygon" style="fill: white" />
								<polygon points="72,64 73,66 74,64" class="water-level-polygon" style="fill: white" />
							...
							<div class="system-head"></div>
							<div class="elevation-height-name">Elevation</div>
							<div class="elevation-height"></div>
							<div class="water-level-name">Pumping Water Level Depth</div>
